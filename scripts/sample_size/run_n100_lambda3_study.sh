...
COMMON_LABEL_PREFIX="fixed_ifeval_lambda_min30_u1_2_cp0_05_sep2_lambda3_n100"

COMMON_N_VALUES="${COMMON_N_VALUES:-100}"
COMMON_P_VALUES_PRODUCT="${COMMON_P_VALUES_PRODUCT:-500,1000,1500,2000}"
COMMON_P_VALUES_GIBBS="${COMMON_P_VALUES_GIBBS:-500,1000}"
COMMON_H_VALUES="${COMMON_H_VALUES:-5,10}"
COMMON_G_CONFIG_TYPES="${COMMON_G_CONFIG_TYPES:-all2,all3}"
...
run_arm() {
  ...
  {
    echo "n=100 lambda=3 study arm: ${arm_label}"
  ...
  export P_VALUES_PRODUCT="${COMMON_P_VALUES_PRODUCT}"
  export P_VALUES_GIBBS="${COMMON_P_VALUES_GIBBS}"
  export H_VALUES="${COMMON_H_VALUES}"
  export G_CONFIG_TYPES="${COMMON_G_CONFIG_TYPES}"
  ...
  export LAMBDA_L1_PENALTY_BY_N=100=3
  export PRETRAIN_LOADING_PENALTY=3
  export ROTATION_LOADING_L1_PENALTY=3
  export LAMBDA_L1_PENALTY=3
  export VIROLI_LAPLACE_L1_PENALTY=3
